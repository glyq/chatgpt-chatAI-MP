...
class User extends Backend
{
    ...
    /**
     * User模型对象
     * @var \app\common\model\robot\User
     */
    protected $model = null;
    protected $searchFields = 'id,nickname,openid,phone';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\common\model\robot\User;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            foreach ($list as $row) {
				...
				$row->getRelation('vip')->visible(['num']);
            }
