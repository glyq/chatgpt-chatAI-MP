 ...
 * @icon fa fa-circle-o
 */
class Channelcate extends Backend
{

    /**
     * Channelcate模型对象
     * @var \app\common\model\robot\Channelcate
     */
    protected $model = null;
    protected $searchFields = 'id,cate.name';
    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\common\model\robot\Channelcate;
    }
